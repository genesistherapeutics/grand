...
class BaseGrandCanonicalMonteCarloSampler(object):
    ...
    """
    def __init__(self, system, topology, temperature, frag_resname='UNK', ghostFile="gcmc-ghost-wats.txt", log='gcmc.log',
        ...
        self.frag_resname = frag_resname
        self.frag_params = self.getFragParameters(frag_resname)
        self.frag
    ...
    def getFragParameters(self, frag_resname):
        """
    ...
    def getFragResids(self, frag_resname):
        """
    ...
    def setFragStatus(self, resid, new_value):
        """
    ...
    def getFragStatusResids(self, value):
        """
    ...
    def getFragStatusValue(self, resid):
        """
