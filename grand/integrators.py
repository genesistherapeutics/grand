...
class PeriodicNonequilibriumIntegrator(AlchemicalNonequilibriumLangevinIntegrator):
    ...
    def _add_alchemical_perturbation_step(self):
        ...
        is_backward_switch = "step((step+0.5)-n_steps_eq)*step((n_steps_eq+n_steps_neq) - (step+0.5))" #logic: define bool forward switch
        is_forward_switch = "step((step+0.5)-(n_steps_eq+n_steps_neq+n_steps_eq))*step(n_steps_per_cycle - (step+0.5))" #logic: define bool backward switch
